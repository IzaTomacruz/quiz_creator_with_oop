...
class QuizVisual:
    def __init__(self, screen, width, height):
        ...
        self.background_img = pygame.transform.scale(
            pygame.image.load("graphics/background1.jpg"), (width, height))
        self.quiz_background = pygame.transform.scale(
            pygame.image.load("graphics/background2.jpg"), (width, height))
        
        # fonts
        self.title_font = pygame.font.Font("graphics/font.ttf", 34)
        self.button_font = pygame.font.Font("graphics/font.ttf", 26)
        self.quiz_font = pygame.font.Font("graphics/font.ttf", 13)
...
def draw_quiz_screen(self, current_question, feedback_text):
    ...
    if current_question:
        ...
        for key, rect in self.choice_buttons.items():
            ...
            choice_text = self.current_question["choices"][key]
